...
st.write("""
    ...
    Используя API бесплатного перевочика DeepL, это остановится когда поиск превышает лимит\n
    Этот генератор не переводит каждое слово из-за того, как перевод ужасный 
""")
